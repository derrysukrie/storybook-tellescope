    ...
    const setup = () => {
        return render(
            <FormControlAtom>
                ...
                <TextField hiddenLabel variant="filled" placeholder="Enter your email..." />
                <FormHelperText>We will never share your email with anyone.</FormHelperText>
            </FormControlAtom>
        )
    }
    ...
    it('renders complete form with error states', () => {
        render(
            <FormControlAtom error>
                ...
                <TextField error hiddenLabel variant="filled" placeholder="Enter your email..." />
    ...
    it('renders form with FormControlLabel', () => {
        render(
            <FormControlAtom>
                ...
                <FormHelperText>You can unsubscribe at any time.</FormHelperText>
            </FormControlAtom>
        )
    ...
    it('renders form with different label sizes', () => {
        render(
            <FormControlAtom>
                ...
                <TextField hiddenLabel variant="filled" placeholder="Enter text..." />
                <FormHelperText>Helper text for large label.</FormHelperText>
            </FormControlAtom>
        )
    ...
    it('renders form with custom styling', () => {
        render(
            <FormControlAtom fullWidth>
                <FormGroupLabel labelSize="large" sx={{ color: 'primary.main' }}>
                    Custom Styled Label
                </FormGroupLabel>
                <TextField hiddenLabel variant="outlined" placeholder="Enter text..." />
                <FormHelperText>Custom styled form.</FormHelperText>
            </FormControlAtom>
        )
        ...
        render(
            <FormControlAtom>
                ...
                <div style={{ display: 'flex', gap: '16px' }}>
                    <TextField hiddenLabel variant="filled" placeholder="First Name" size="small" />
                    <TextField hiddenLabel variant="filled" placeholder="Last Name" size="small" />
                </div>
    ...
    it('maintains accessibility in integrated form', () => {
        render(
            <FormControlAtom>
                ...
                <TextField hiddenLabel variant="filled" placeholder="Enter text..." />
                <FormHelperText>This form is accessible.</FormHelperText>
            </FormControlAtom>
        )
