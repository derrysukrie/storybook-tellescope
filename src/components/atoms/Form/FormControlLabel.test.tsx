...
describe("FormControlLabel", () => {
  ...
  it("renders with default props", () => {
    ...
    expect(formControlLabel?.classList.contains("MuiFormControlLabel-labelPlacementEnd")).toBe(true);
  });
  ...
  it("applies different label placements", () => {
    ...
    expect(bottomLabel?.classList.contains("MuiFormControlLabel-labelPlacementBottom")).toBe(true);
  });
  ...
  it("forwards all MUI FormControlLabel props", () => {
    ...
    const formControlLabel = container.querySelector(".MuiFormControlLabel-root");
    expect(formControlLabel).toBeTruthy();
    expect(formControlLabel?.classList.contains("MuiFormControlLabel-labelPlacementStart")).toBe(true);
  });
