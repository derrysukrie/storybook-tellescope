...
describe('LoadingButton', () => {
    ...
    it('disables button and swaps children with center spinner + indicator', () => {
        render(
            <LoadingButton loading loadingPosition="center" loadingIndicator="Loading...">
                Save
            </LoadingButton>
        )
        const btn = screen.getByRole('button')
    ...
    it('forwards color to MUI', () => {
        const { container, rerender } = render(
            <LoadingButton appearance="contained" color="primary">
                A
            </LoadingButton>
        )
        ...
        rerender(
            <LoadingButton appearance="contained" color="secondary">
                A
            </LoadingButton>
        )
        ...
        rerender(
            <LoadingButton appearance="contained" color="info">
                A
            </LoadingButton>
        )
