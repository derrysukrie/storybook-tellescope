...
describe("Button", () => {
  ...
  it("respects aria-label for accessible name", () => {
    const { getByRole } = renderWithTheme(
      <Button aria-label="Do action">Click me</Button>
    );
  ...
  it("maps appearance to MUI variant (contained|outlined|text)", () => {
    const { container, rerender } = renderWithTheme(
      <Button appearance="contained">A</Button>
    );
  ...
  it("maps color to MUI color classes", () => {
    ...
    rerender(<Button appearance="contained" color="secondary">A</Button>);
    expect(container.querySelector(".MuiButton-containedSecondary")).not.toBeNull();

    rerender(<Button appearance="contained" color="info">A</Button>);
