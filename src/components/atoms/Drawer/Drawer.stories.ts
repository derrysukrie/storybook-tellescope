...
const meta = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component:
                    'A versatile drawer component built with Material UI that can slide in from any direction. Supports both controlled and uncontrolled modes, customizable content, and various anchoring positions.',
            },
        },
    },
    argTypes: {
...
const SampleContent = React.createElement(
    ...
    React.createElement(
        ...
        'This is a sample drawer with some content.'
    ),
    React.createElement(
        Typography,
        { variant: 'body2', color: 'text.secondary', sx: { mb: 3 } },
        'You can put any content inside the drawer.'
    ),
...
const PersistentContent = React.createElement(
    ...
    React.createElement(
        Typography,
        { variant: 'body1', sx: { mb: 2 } },
        'This is a persistent drawer.'
    ),
    React.createElement(
        Typography,
        { variant: 'body2', color: 'text.secondary', sx: { mb: 2 } },
        'It should push the main content to the left when open.'
    ),
...
const MainContentWithBackground = React.createElement(
    ...
    React.createElement(
        Typography,
        { variant: 'h3', sx: { mb: 3, textAlign: 'center' } },
        'Main Content Area'
    ),
    React.createElement(
        Typography,
        { variant: 'h6', sx: { mb: 4, textAlign: 'center', opacity: 0.9 } },
        'This content should be pushed to the left when the persistent drawer is open'
    ),
    React.createElement(
        Box,
        {
        ...
        React.createElement(
            ...
            React.createElement(
                Typography,
                { variant: 'body2' },
                'More content to demonstrate layout'
            )
        ),
        React.createElement(
            Box,
            ...
            React.createElement(
                Typography,
                { variant: 'body2' },
                'Watch how this content moves when drawer opens'
            )
        )
    )
)
