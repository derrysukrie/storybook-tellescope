...
describe('Drawer', () => {
    ...
    describe('Mode Comparison', () => {
        it('renders different DOM structure for temporary vs persistent', () => {
            // Temporary mode
            const { container: tempContainer } = setup({
                open: true,
                persistent: false,
            })
            ...
            // Persistent mode
            const { container: persContainer } = setup({
                open: true,
                persistent: true,
            })
        ...
        it('both modes support title and children props', () => {
            ...
            rerender(
                <Drawer open={true} persistent={true} title="Pers Title">
                    <div data-testid="pers-content">Pers Content</div>
                </Drawer>
            )
