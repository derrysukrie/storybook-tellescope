...
describe("Radio", () => {
  ...
  describe("Event handling", () => {
    it("calls onChange when radio is clicked", () => {
      ...
      const { container } = renderWithTheme(
        <Radio onChange={mockOnChange} value="test" />
      );
  ...
  describe("Accessibility", () => {
    it("has proper ARIA attributes", () => {
      ...
      const hasAriaLabel = radioInput?.hasAttribute("aria-label") || rootElement?.hasAttribute("aria-label");
    ...
    it("supports custom id attribute", () => {
      const { container } = renderWithTheme(<Radio id="custom-radio" />);
      const radioInput = container.querySelector("input[type='radio']");
