...
describe('FileUpload', () => {
    ...
    describe('Edge Cases', () => {
        ...
        it('handles very long filenames', () => {
            const longFilename =
                'this_is_a_very_long_filename_that_might_exceed_normal_display_widths_and_could_potentially_cause_layout_issues_if_not_handled_properly_by_the_component.jpg'
            const longFile: FileItem[] = [{ name: longFilename, size: 1024, status: 'pre-upload' }]
