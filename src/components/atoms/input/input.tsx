...
import { FormControl, InputAdornment, TextField as MuiTextField } from '@mui/material'
    ...
    return (
        <FormControl variant={appearance} size={size} error={error} {...FormControlProps}>
            <MuiTextField
                ...
                InputLabelProps={{
                    shrink: currentValue.length > 0 || !!placeholder,
                    ...InputLabelProps,
                }}
                size={size}
                label={label}
                ...
                sx={{
                    ...
                    '& .Mui-error.MuiInputLabel-root[data-shrink="false"]': {
                        color:
                            currentValue.length > 0 ? undefined : 'rgba(0, 0, 0, 0.6) !important',
                    },
