...
const PortalStatus = ({
    ...
    return (
        <Box display="flex" alignItems="center" gap={1}>
            {config.showStatus && !completed && <ErrorOutline color="error" fontSize="inherit" />}
...
const PortalAvatar = ({ src, show }: { src?: string; show?: boolean }) => {
    ...
    return <Avatar sx={{ width: 24, height: 24 }} src={src} />
}
    ...
    return (
        ...
        >
            <Stack direction="row" alignItems="center" gap={2}>
                ...
                <Box display="flex" flexDirection="column" gap={hasStatusOrDateTime ? 0.4 : 0}>
            ...
            <Stack direction="row" alignItems="center" gap={1}>
                ...
                <PortalAvatar src={avatarSrc} show={config.showAvatar} />
                <ChevronRight />
            </Stack>
        </Box>
    )
