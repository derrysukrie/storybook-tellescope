...
export const CareTeamInfo = ({ actions = 1 }: CareTeamInfoProps) => {
    ...
    const getButtonWidth = () => {
        switch (actions) {
            case 2:
                return BUTTON_STYLES.width.double
            case 3:
                return BUTTON_STYLES.width.triple
            default:
                return BUTTON_STYLES.width.single
        }
    }
                        ...
                        {actionButtons.map((action, index) => (
                            ...
                            >
                                ...
                                {index < actionButtons.length - 1 && (
                                    <Divider orientation="vertical" flexItem sx={DIVIDER_STYLES} />
                                )}
                            </Box>
                        ))}
                    </Stack>
