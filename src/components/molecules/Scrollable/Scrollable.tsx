...
const activities = [
    {
        icon: <ConfirmationNumberOutlinedIcon sx={{ color: '#1F1F1F', fontSize: '24px' }} />,
    ...
    {
        icon: <CheckCircleOutlineIcon sx={{ color: '#1F1F1F', fontSize: '24px' }} />,
        title: 'Chat resolved',
...
const ScrollableSection: React.FC = () => (
    ...
    >
        <Box display="flex" justifyContent="flex-start" alignItems="center" mb={2} gap={'10px'}>
            ...
            {activities.map((activity, index) => (
                ...
                >
                    ...
                    <Box component="div" flexGrow={1}>
                        <Typography fontWeight={500} fontSize="small" color="rgba(0, 0, 0, 1)">
                            {activity.title}
                        </Typography>
                        <Typography
                            variant="caption"
                    ...
                    <ArrowForwardIosIcon sx={{ fontSize: '14px', color: 'rgba(31, 31, 31, 1)' }} />
                </Box>
            ))}
        </Box>
    </Paper>
