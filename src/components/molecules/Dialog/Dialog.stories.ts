...
const meta = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component:
                    'A versatile dialog component built with Material UI that supports various configurations including different sizes, actions, and content types.',
            },
        },
    },
    argTypes: {
        ...
        actions: {
            ...
            mapping: {
                none: [],
                one: [{ label: 'Confirm', onClick: fn(), variant: 'contained' }],
                two: [
...
export const Default: Story = {
    args: {
        children: React.createElement(
            Typography,
            {},
            'This is a sample dialog description that explains what the dialog is for and provides context to the user.'
        ),
        background: false,
        title: 'Dialog Title',
    },
...
export const Collapsed: Story = {
    args: {
        ...
        children: React.createElement(
            Typography,
            {},
            'This dialog starts in collapsed state and can be expanded to show this content.'
        ),
    },
}
