...
export const useEstimateMessageHeight = (message: IMessage, lastDate: Date | null): number => {
    let height = 0
    ...
    if (message.createdAt) {
        const showDateSeparator =
            !lastDate || lastDate.toDateString() !== new Date(message.createdAt).toDateString()
