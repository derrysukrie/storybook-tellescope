...
const SectionItemContainer: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    return (
        <Box
            sx={{
                display: 'flex',
...
const SectionItemSubTitle: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    return (
        <Typography
            component="label"
            fontSize="12px"
...
export const TicketSectionItem: React.FC<TicketSectionItemProps> = ({
    ...
    return (
        <SectionItemContainer>
            ...
            {!snoozed && <Snooze sx={{ fontSize: '24px', color: '#49454F' }}></Snooze>}

            {assigned && snoozed && (
                <img alt="dumpling" src={DumplingIcon} width={24} height={24} />
            )}

            {snoozed && <AlarmOffOutlined sx={{ fontSize: '24px', color: '#49454F' }} />}
...
export const PrescriptionSectionItem: React.FC<PrescriptionSectionItemProps> = ({
    status = 'Pending',
    name = '',
}) => {
    return (
...
export const MedicationSectionItem: React.FC<{ name?: string }> = ({ name }) => {
    return (
        <SectionItemContainer>
    ...
    return (
        <SectionItemContainer>
            ...
            <Box component="div" flexGrow={1}>
                ...
                <SectionItemSubTitle>$100 March 5, 2025 A descriptive expl...</SectionItemSubTitle>
            </Box>
...
export const ContentSectionItem: React.FC<{ name?: string; icon?: string }> = ({ name, icon }) => {
    return (
        <SectionItemContainer>
...
export const DeviceOrderSectionItem: React.FC<{ name?: string }> = ({ name }) => {
    return (
        <SectionItemContainer>
    ...
    return (
        <SectionItemContainer>
            ...
            <Box component="div" flexGrow={1}>
                ...
                <SectionItemSubTitle>3/5/2025 at 1:15 PM PST &nbsp; In Candid</SectionItemSubTitle>
            </Box>
...
export const TicketassignedSectionItem: React.FC<{ name?: string }> = ({ name }) => {
    return (
        <SectionItemContainer>
            {<img alt="ticket" src={TicketIcon} width={24} height={24} />}
            <Box component="div" flexGrow={1}>
...
export const TicketcompletedSectionItem: React.FC<{ name?: string }> = ({ name }) => (
    <SectionItemContainer>
        {<img alt="ticket" src={TicketIcon} width={24} height={24} />}
        <Box component="div" flexGrow={1}>
...
export const EventScheduledSectionItem: React.FC<{ name?: string }> = ({ name }) => {
    return (
        <SectionItemContainer>
            {<img alt="event" src={EventIcon} width={24} height={24} />}
...
export const EventCancelledSectionItem: React.FC<{ name?: string }> = ({ name }) => {
    return (
        <SectionItemContainer>
...
export const ChatResolvedSectionItem: React.FC<{ name?: string }> = ({ name }) => {
    return (
        <SectionItemContainer>
...
export const AddedToJourneySectionItem: React.FC<{ name?: string }> = ({ name }) => {
    return (
        <SectionItemContainer>
...
export const RemovedFromJourneySectionItem: React.FC<{ name?: string }> = ({ name }) => {
    return (
        <SectionItemContainer>
            {<img alt="journey" src={JourneyIcon} width={24} height={24} />}
