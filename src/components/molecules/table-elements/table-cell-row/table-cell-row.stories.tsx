        ...
        return (
            <div>
                <TableCellRow>
                    {column === 'text' && (
                        <TableCell>
                            {checkbox ? <CheckBox color="primary" /> : null}
                    ...
                    {column === 'select' && (
                        <TableCell>
                            ...
                            >
                                ...
                                <MenuItem value="Synt to Healthie" key="Synt to Healthie">
                                    Synt to Healthie
                                </MenuItem>
                                <MenuItem value="Content campaign" key="Content campaign">
                                    Content campaign
                                </MenuItem>
                                <MenuItem value="Chip 1" key="Chip 1">
                                    Chip 1
                                </MenuItem>
                                <MenuItem value="Chip 2" key="Chip 2">
                                    Chip 2
                                </MenuItem>
                                <MenuItem value="Chip 3" key="Chip 3">
                                    Chip 3
                                </MenuItem>
                            </SelectBase>
                        </TableCell>
