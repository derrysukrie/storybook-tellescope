...
function DetailSelectFilter() {
    const { sort, setSort, open, onChangeFilter, buttonContent, valueSort, placeholder, onClose } =
        ...
        <>
            {!buttonContent ? (
                ...
                >
                    ...
                    <Typography sx={{ fontWeight: 500, ml: 0.5 }} variant="body2">
                        Filter
                    </Typography>
                </Button>
            ) : (
...
function FilterMenu({
    ...
    const { availableFilterFields } = useDetailSelectContext()
    const [searchTerm, setSearchTerm] = useState<string>('')
    const search = availableFilterFields.filter(f =>
