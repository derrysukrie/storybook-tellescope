...
import TableCell, {
    type TableCellProps,
} from '../../atoms/table-control-elements/table-cell/table-cell'
...
import TableTabsFiltersControls, {
    useFilterContext,
} from '../../molecules/table-elements/table-tabs-filters-controls/table-tabs-filters-controls'
        ...
        <Stack>
            ...
            >
                <MuiTable stickyHeader aria-label="sticky table">
                    ...
                    {data.map((row, index) => (
                        <TableCellRow key={index.toString()}>
                            <TableCell
                                width={'20%'}
