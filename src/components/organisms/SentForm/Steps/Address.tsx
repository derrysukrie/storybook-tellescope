...
export const Address = () => {
  ...
  //       ...addressData, // Use addressData directly instead of address
  //       [field]: value,
  //     };
  //     handleAddressChange(updatedAddress);
  //   },
  //   [addressData, handleAddressChange] // Use addressData instead of address
  // );

  // // Event handlers for Input components
  // const handleAddressLine1InputChange = useCallback(
