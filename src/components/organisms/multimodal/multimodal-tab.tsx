...
export const EventMultimodalTabContent: React.FC<{ nameSorted: boolean }> = ({ nameSorted }) => {
    const allEvents = [
    ...
    return (
        <Box component="div" sx={{ mt: 2 }}>
            ...
            >
                ...
                <Box component="div" sx={{ mt: 2 }}>
                    {items.map((item, index) => (
                        <DeviceOrderSectionItem key={index.toString()} name={item.name} />
                    ))}
                </Box>
            </Paper>
        </Box>
    ...
    return (
        <Box component="div" sx={{ mt: 2 }}>
            ...
            >
                ...
                <Box component="div" sx={{ mt: 2 }}>
                    {items.map((item, index) => (
                        <EncounterSectionItem key={index.toString()} name={item.name} />
                    ))}
                </Box>
            </Paper>
        </Box>
    ...
    return (
        <Box component="div" sx={{ mt: 2 }}>
            ...
            >
                ...
                <Box component="div" sx={{ mt: 2 }}>
                    {items?.map((item, index) => (
                        <FileSectionItem key={index.toString()} name={item.name} />
                    ))}
                </Box>
            </Paper>
        </Box>
...
export const FormsMultimodalTabContent: React.FC<{ nameSorted: boolean }> = ({ nameSorted }) => {
    ...
    return (
        <Box component="div" sx={{ mt: 2 }}>
            ...
            >
                ...
                <Box component="div" sx={{ mt: 2 }}>
                    {items.map((item, index) => (
                        <FormSectionItem key={index.toString()} name={item.name} />
                    ))}
                </Box>
            </Paper>
        </Box>
...
export const ContentMultimodalTabContent: React.FC<{ nameSorted: boolean }> = ({ nameSorted }) => {
    ...
    return (
        <Box component="div" sx={{ mt: 2 }}>
            ...
            >
                ...
                <Box component="div" sx={{ mt: 2 }}>
                    {items.map((item, index) => (
                        <MedicationSectionItem key={index.toString()} name={item.name} />
                    ))}
                </Box>
            </Paper>
        </Box>
...
export const PaymentsMultimodalTabContent: React.FC<{
    ...
    const allItems = [{ name: 'Payment' }, { name: 'Credit' }, { name: 'Superbill' }]
    ...
    return (
        <Box component="div" sx={{ mt: 2 }}>
            ...
            >
                ...
                <Box component="div" sx={{ mt: 2 }}>
                    {items.map((item, index) => (
                        <PaymentSectionItem key={index.toString()} name={item.name} />
                    ))}
                </Box>
            </Paper>
        </Box>
