...
import type AddTicketIcon from '../../../assets/add-ticket.svg'
...
import type SortingIcon from '../../../assets/sorting.svg'
...
export const MultimodalIcons: React.FC<{ IconName: MultimodalIconType }> = ({ IconName }) => {
